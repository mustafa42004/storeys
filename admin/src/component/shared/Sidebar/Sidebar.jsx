        ...
        <ul className="navbar-nav">
          ...
          <li className="nav-item">
            <NavLink to="/property" className="nav-link ">
              ...
              <span className="nav-link-text ms-1">List Properties</span>
            </NavLink>
          </li>
          <li className="nav-item">
            <NavLink className="nav-link  " to="create-property">
              <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <svg
                  width="12px"
                  height="12px"
              ...
              <span className="nav-link-text ms-1">Create Property</span>
            </NavLink>
          </li>{" "}
          <li className="nav-item mt-3">
            <h6 className="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">
          ...
          <li className="nav-item">
            <NavLink to="/contacts" className="nav-link ">
              ...
              <span className="nav-link-text ms-1">List Contacts</span>
            </NavLink>
          </li>
          <li className="nav-item mt-3">
            <h6 className="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">
          ...
          <li className="nav-item">
            <NavLink to="/careers" className="nav-link ">
              ...
              <span className="nav-link-text ms-1">List Careers</span>
            </NavLink>
          </li>
          <li className="nav-item mt-3">
            <h6 className="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">
          ...
          <li className="nav-item">
            <NavLink to="/amenity" className="nav-link ">
              <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <svg
                  width="12px"
                  height="12px"
              ...
              <span className="nav-link-text ms-1">List Amenities</span>
            </NavLink>
          </li>
          <li className="nav-item">
            <NavLink className="nav-link  " to="create-amenity">
              <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <svg
                  width="12px"
                  height="12px"
              ...
              <span className="nav-link-text ms-1">Create Amenity</span>
            </NavLink>
          </li>
          <li className="nav-item mt-3">
            <h6 className="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">
          ...
          <li className="nav-item">
            <NavLink className="nav-link  " to="/teams">
              ...
              <span className="nav-link-text ms-1">Teams List</span>
            </NavLink>
          </li>{" "}
          <li className="nav-item">
            <NavLink className="nav-link  " to="/create-teams">
              <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <svg
                  width="12px"
                  height="12px"
          ...
          <li className="nav-item">
            <NavLink className="nav-link  " to="/news">
              ...
              <span className="nav-link-text ms-1">List News</span>
            </NavLink>
          </li>
          <li className="nav-item">
            <NavLink className="nav-link  " to="/create-news">
              <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <svg
                  width="12px"
                  height="12px"
              ...
              <span className="nav-link-text ms-1">Add News</span>
            </NavLink>
          </li>
          <li className="nav-item mt-3">
            <h6 className="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">

...
const Banners = ({ fetchBanners, savedBanners }) => {
  ...
  const [banners, setBanners] = useState([{ banner: null, preview: "" }]);
  ...
  const addBanner = () =>
    setBanners([...banners, { banner: null, preview: "" }]);
                ...
                <>
                  ...
                  <div className="mb-2 flex-cs w-100 header">
                    ...
                    {removed.includes(value.s3Key) ? (
                      ...
                      <button
                        type="button"
                        onClick={() => setRemoved([...removed, value.s3Key])}
            ...
            {banners?.map((value, index) => (
              <>
                ...
                <input
                  ...
                  type="file"
                  ref={bannerRef}
                  onChange={(e) => updateBanner(index, e.target.files[0])}
                ...
                <div key={index} className="layout">
                  {value.banner ? (
                    ...
                    >
                      <i className="fa-solid fa-plus" /> &nbsp; Banner
                      {index + 1}
                    </button>
                  )}
                </div>

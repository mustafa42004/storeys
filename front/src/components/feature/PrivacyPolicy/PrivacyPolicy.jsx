  ...
  return (
    <>
      ...
      <div className="container mt-lg-4 mt-3 py-5">
        ...
        <p>
          <strong>Effective Date:</strong> 01/04/2024
        </p>
        <p>
        ...
        <ul>
          ...
          <li>
            <strong>Property Preferences:</strong> Budget, location, property
            type
          </li>
          <li>
            <strong>Transaction Information:</strong> Property inquiries,
            bookings, service requests
          </li>
          <li>
            <strong>Technical Data:</strong> IP address, browser type, device
            information, and usage data via cookies
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>
            Send updates, offers, and newsletters (you can opt out at any time)
          </li>
        ...
        <ul>
          ...
          <li>
            Trusted third-party service providers (e.g., CRM systems, marketing
            platforms, mortgage advisors)
          </li>
          <li>
            Legal authorities when required by law or for compliance purposes
          </li>
        </ul>
        <p>
          All third-party partners are required to maintain confidentiality and
        ...
        <p>
          ...
          settings. However, some features of the Site may not function properly
        ...
        <ul>
          <li>
            📧 <a href="mailto:enquiries@storeys.ae">enquiries@storeys.ae</a>
          </li>
          <li>
            📞 <a href="tel:+971567897077">+971 56 7897077</a>
          </li>
        </ul>
      </div>

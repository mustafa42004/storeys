    ...
    <>
        <div className="center ">
            <div className="item divide ">
                <div>
                    <h4 className="font-sm text-left dark medium fs-16">3 &nbsp; <img src="/assets/img/bed.svg" alt="" className="icon" /></h4>
                </div>
            ...
            <div className="item divide">
                <div>
                    <h4 className="font-sm text-left dark medium fs-16">2 &nbsp; <img src="/assets/img/bathroom.svg" alt="" className="icon" /></h4>
                </div>
